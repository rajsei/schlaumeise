...
2. Download and open Raspberry Pi Imager from [raspberrypi.com/software/](https://www.raspberrypi.com/software/). Simply follow the installation instructions.

3. After starting the software, select the model you own.  
   ![Screenshot of Raspberry Pi Imager](/schlaumeise//images/project01/pi-setup/01.png)
